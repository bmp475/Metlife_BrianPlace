...
part2=pd.read_csv('locations.csv', na_values = '\N')

setKey("64da7a4c26c94e15801135504171008", "premium")
...
with open('locations.csv') as csvfile:
        ...
        for row in reader:
                ...
                # Create the query_string arg for LocalWeather

                q = "{0},{1}".format(row['latitude'],row['longitude'])

                # Call wrapper function LocalWeather

                w= LocalWeather(q, format="json")
